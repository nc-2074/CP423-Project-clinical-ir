...
def notify_n8n(transcript_path: str, audio_path: str, segment_count: int, session_id: str):
    """
...
def pipeline():
    ...
    # Index directly in Flask — keeps session_id consistent
    ...
    # Still notify n8n for analysis only
...
def index_endpoint():
    ...
    print(f"  Index called with session_id: {session_id}")
